  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Neutral (for backgrounds, borders)
        neutral: {
          50: '#fafafa',
          100: '#f5f5f5',
          200: '#e5e5e5',
      ...
      fontSize: {
        ...
        // Label sizes
        'label-lg': ['0.875rem', { lineHeight: '1.5', letterSpacing: '0.01em' }],
        'label': ['0.75rem', { lineHeight: '1.5', letterSpacing: '0.01em' }],
        'label-sm': ['0.625rem', { lineHeight: '1.5', letterSpacing: '0.02em' }],
      },
      fontWeight: {
        thin: '100',
        extralight: '200',
      ...
      // Breakpoints (already included in Tailwind, but explicitly defined)
      screens: {
        xs: '475px',
        sm: '640px',
        md: '768px',
